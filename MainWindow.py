...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(20, 90, 231, 601))
        ...
        self.btn_start_modem = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_start_modem.setObjectName("btn_start_modem")
        self.verticalLayout_2.addWidget(self.btn_start_modem)
        ...
        self.btn_wr_cert2 = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_wr_cert2.setObjectName("btn_wr_cert2")
        self.verticalLayout_2.addWidget(self.btn_wr_cert2)
        self.btn_tx_cert2 = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_tx_cert2.setObjectName("btn_tx_cert2")
        self.verticalLayout_2.addWidget(self.btn_tx_cert2)
        self.btn_tx_cert2_modem = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_tx_cert2_modem.setObjectName("btn_tx_cert2_modem")
        self.verticalLayout_2.addWidget(self.btn_tx_cert2_modem)
        self.btn_wr_cert3 = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_wr_cert3.setObjectName("btn_wr_cert3")
        self.verticalLayout_2.addWidget(self.btn_wr_cert3)
        self.btn_tx_cert3 = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_tx_cert3.setObjectName("btn_tx_cert3")
        self.verticalLayout_2.addWidget(self.btn_tx_cert3)
        self.btn_tx_cert3_modem = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_tx_cert3_modem.setObjectName("btn_tx_cert3_modem")
        self.verticalLayout_2.addWidget(self.btn_tx_cert3_modem)
        self.btn_start_modem_mqtt = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btn_start_modem_mqtt.setObjectName("btn_start_modem_mqtt")
        self.verticalLayout_2.addWidget(self.btn_start_modem_mqtt)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_start_modem.setText(_translate("MainWindow", "CONFIG MODEM SMS CALL"))
        ...
        self.btn_wr_cert2.setText(_translate("MainWindow", "TX CERT 2 TO uCc"))
        self.btn_tx_cert2.setText(_translate("MainWindow", "TX CERT 2 TO uCm"))
        self.btn_tx_cert2_modem.setText(_translate("MainWindow", "TX CERT 2 TO MODEM"))
        self.btn_wr_cert3.setText(_translate("MainWindow", "TX CERT 3 TO uCc"))
        self.btn_tx_cert3.setText(_translate("MainWindow", "TX CERT 3 TO uCm"))
        self.btn_tx_cert3_modem.setText(_translate("MainWindow", "TX CERT 3 TO MODEM"))
        self.btn_start_modem_mqtt.setText(_translate("MainWindow", "CONFIG MODEM MQTT"))
